...
const MyProfile = () => {
  ...
  return userData && (
    ...
    <div className='mt-10'>
     {
       isEdit
       ? <button className='border border-blue-600 px-8 py-2 rounded-full hover:bg-blue-600 hover:text-white transition-all duration-200' onClick={updateUserProfileData}>Save Information</button>
