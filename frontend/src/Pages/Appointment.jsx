    ...
    doctInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          {/* Horizontal scroll for day slots */}
          <div className="flex gap-3 items-center w-full overflow-x-auto whitespace-nowrap mt-4 pb-2">
            {docSlots.length &&
          ...
          <div className="flex items-center gap-2 w-full overflow-x-auto whitespace-nowrap mt-2 pb-2">
            {docSlots.length &&
