...
const Appointments = () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        const isSlotAvailable = !(
          doctInfo.slots_booked[slotDate] &&
  ...
  return (
    ...
    <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
      ...
      <div className='flex gap-3 items-center overflow-x-auto max-w-full whitespace-nowrap mt-4 pb-2 scroll-smooth'>
        {
      ...
      <div className='flex items-center gap-2 overflow-x-auto max-w-full whitespace-nowrap mt-2 pb-2 scroll-smooth'>
        {
